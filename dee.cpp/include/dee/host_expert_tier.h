...
// The Phase-2 host-policy result is intentionally the unmodified LRU: every
// record is dynamic and the least-recently-used idle slot is offered first.
// This is a production policy object, not a frequency pinning policy.
class PlainLruHostPlacementPolicy final : public HostPlacementPolicy {
public:
